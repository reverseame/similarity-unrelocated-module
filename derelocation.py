...
def derelocation_delay_import(pe):
    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[13].VirtualAddress and hasattr(
            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[13], 'directory'):
        if pe.NT_HEADERS.OPTIONAL_HEADER.Magic == OPTIONAL_HEADER_MAGIC_PE:  # X86
...
def derelocation_LoadConfig(pe):
    ...
    try:
        if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].VirtualAddress and hasattr(
                pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10], 'directory'):
            if pe.NT_HEADERS.OPTIONAL_HEADER.Magic == OPTIONAL_HEADER_MAGIC_PE:  # X86
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 36:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.LockPrefixTable:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 32)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 60:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.EditList:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 56)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 64:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.SecurityCookie:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 60)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 68:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.SEHandlerTable:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 64)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 76:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardCFCheckFunctionPointer:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 72)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 80:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardCFDispatchFunctionPointer:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 76)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 84:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardCFFunctionTable:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 80)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 108:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardAddressTakenIatEntryTable:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 108)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 116:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardLongJumpTargetTable:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 116)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 124:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.DynamicValueRelocTable:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 120)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 128:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.CHPEMetadataPointer:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 124)
                else:
                    return
                ...
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 132:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardRFFailureRoutine:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 128)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 136:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardRFFailureRoutineFunctionPointer:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 132)
                else:
                    return

                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 148:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[
                        10].directory.GuardRFVerifyStackPointerFunctionPointer:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 144)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 160:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.EnclaveConfigurationPointer:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 156)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 164:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.VolatileMetadataPointer:
                        pe.set_zero_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 160)
                else:
                    return
                ...
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 48:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.LockPrefixTable:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 40)
                else:
                    return
                ...
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 96:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.SecurityCookie:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 88)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 104:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.SEHandlerTable:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 96)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 120:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardCFCheckFunctionPointer:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 112)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 128:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardCFDispatchFunctionPointer:
                ...
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 184:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardLongJumpTargetTable:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 176)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 200:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.DynamicValueRelocTable:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 192)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 208:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.CHPEMetadataPointer:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 200)
                else:
                    return
                ...
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 216:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardRFFailureRoutine:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 208)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 224:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.GuardRFFailureRoutineFunctionPointer:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 216)
                else:
                    return
                ...
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 240:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[
                        10].directory.GuardRFVerifyStackPointerFunctionPointer:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 232)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 256:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.EnclaveConfigurationPointer:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 248)
                else:
                    return
                if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.Size >= 264:
                    if pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.VolatileMetadataPointer:
                        pe.set_zero_double_word(
                            pe.NT_HEADERS.OPTIONAL_HEADER.DATA_DIRECTORY[10].directory.get_file_offset() + 256)
                else:
                    return
...
def derelocation_code_86(pe):
    ...
    for index in range(code_section.VirtualAddress, code_section.VirtualAddress + int(code_section.real_size),
        ...
        if pe.__base_address__ <= address <= pe.__base_address__ + pe.__size__:
            ...
            if num_elements > ELEMENTS_TO_TABLE:
                ...
                if not_visited:
                    pe.set_visited(pointer=previous_element[0], size=index - previous_element[0] + 4,
                                   tag=MARKS['TABLE'])
    ...
    while code_rva_offset < code_section.VirtualAddress + int(code_section.real_size) and MARKS[
        ...
        while 0 in instruction_vector:  # While exist a possible initial address
            ...
            instruction_vector[
                instuction_index] = length_inst_sec if length_inst_sec else -1  # Avoid inspect a instruction several times
            if break_loop:
                break
        ...
        if max_length > 0:
            ...
            for inst in md.disasm(
                    pe.__data__[code_rva_offset + longest_index:code_rva_offset + longest_index + max_length],
                    code_rva_offset + longest_index):
...
def derelocation_code_64(pe):
    ...
    # for index in range(code_section.VirtualAddress, code_section.VirtualAddress + code_section.real_size, 8): # Python 2
    for index in range(int(code_section.VirtualAddress), int(code_section.VirtualAddress + code_section.real_size), 8):
...
# Only called from the function get_reloc_section, which is never called
# It has a volatility dependency that cannot be resolved (utils)
...
#                         logger.debug("IOError: Pid: {0} File: {1} PhysAddr: {2} Size: {3}".format(summaryinfo['pid'],
#                                                                                                   summaryinfo['name'],
#                                                                                                   mdata[0], mdata[2]))
#
#                     if not rdata:
...
#                     continue
#             else:
#                 logger.debug("Caso no esperado: {0}".format(summaryinfo['type']))
#         if output:
#             output = ''.join(output)
#             try:
...
#         logger.debug("Warning: Something was wrong when retrieving {0} from dump".format(file_obj.FileName))
#         return None
...
def get_normalized_module_name(mod):
    ...
    if mod.FullDllName:
        if str(mod.FullDllName)[0] != '\\':  # "C:\folder1\folder2\.." or "D:\folder1\folder2\.."
            ...
            logger.debug('Warning: Module name pattern not recognized for {0}'.format(str(mod.FullDllName)))
...
# It calls another function (get_pe_from_file_object) that has a volatility dependency that cannot be resolved
...
#                             logger.debug('Invalid reloc section for {0}\n'.format(file_handler.FileName))
#                             return None
#                     else:
#                         logger.debug('Error: PEfile coulde not be created for {0}\n'.format(file_handler.FileName))
#                     del pe
#                 except PEFormatError as e:
#                     logger.debug('Error retrieving Reloc for {0}\n'.format(file_handler.FileName))
#                     self.reloc_list[mod_sys_name] = None
#                     return None
#             else:
#                 logger.debug('{0} does not have file_handler\n'.format(mod_sys_name))
#         return reloc_data
#     else:
#         logger.debug('Error retrieving module name\n')
#         return None


# This function is never called
# It has a volatility dependency that cannot be resolved (plugins)
